// Minimal woo net client for plug Workers. The apikey authenticates every
// request; a short-lived net session supplies the actor's presence anchor for
// exact cell reads and sequenced turns.
