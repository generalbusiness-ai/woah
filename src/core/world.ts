...
export class WooWorld {
  ...
  applyCommittedShadowTranscript(transcript: EffectTranscript): void {
    ...
    this.applyCommittedShadowTranscriptInPlace(transcript, Date.now());
  }

  private applyCommittedShadowTranscriptInPlace(transcript: EffectTranscript, objectTimestamp: number): void {
    this.bumpMutationVersion();
    this.hostSeedCache.clear();
