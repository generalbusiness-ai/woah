...
export function v2ServerAssistedIntentPolicy(input: {
  ...
  allowSelectedDurableIntent?: boolean;
  ...
  if (input.allowSelectedDurableIntent && input.selectedScopeAd) return { ok: true, reason: "scope_ad", selected_ad: input.selectedScopeAd };
